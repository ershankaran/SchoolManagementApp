-- INSERT Students			
insert into student (student_id, student_name, student_email) values (1, 'John Warton', 'warton@sma.org');
insert into student (student_id, student_name, student_email) values (2, 'Mike Lanister', 'lanister@sma.org');
insert into student (student_id, student_name, student_email) values (3, 'Steve Reeves', 'Reeves@sma.org');
insert into student (student_id, student_name, student_email) values (4, 'Ronald Connor', 'connor@sma.org');
insert into student (student_id, student_name, student_email) values (5, 'Jim Salvator', 'Sal@sma.org');
insert into student (student_id, student_name, student_email) values (6, 'Peter Henley', 'henley@sma.org');
insert into student (student_id, student_name, student_email) values (7, 'Richard Carson', 'carson@sma.org');
insert into student (student_id, student_name, student_email) values (8, 'Honor Miles', 'miles@sma.org');
insert into student (student_id, student_name, student_email) values (9, 'Tony Roggers', 'roggers@sma.org');
