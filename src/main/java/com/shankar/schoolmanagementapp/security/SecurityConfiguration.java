    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
       ...
       return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers("/classrooms/new").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/students/new").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/teachers/new").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/students/save").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/teachers/save").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/classrooms/save").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/classrooms/update*").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/classrooms/delete*").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/students/update*").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/students/delete*").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/teachers/update*").hasAuthority("ROLE_ADMIN")
            .requestMatchers("/teachers/delete*").hasAuthority("ROLE_ADMIN")
